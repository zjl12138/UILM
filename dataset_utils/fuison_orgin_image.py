...
if __name__ == '__main__':
    ...
    img_root_path = '/media/sda1/cyn-workspace/mmdetection/my_dataset_new/'
    save_dir_path_dlable="/media/sda1/cyn-workspace/mmdetection/demo/3.9/dlable"
    save_dir_path_flable = "/media/sda1/cyn-workspace/mmdetection/demo/3.9/flable"
    save_dir_path_fuison="/media/sda1/cyn-workspace/mmdetection/demo/3.9/fusion"
    save_dir_path_default="/media/sda1/cyn-workspace/mmdetection/demo/3.9/default"

    mkdir_all(save_dir_path_dlable, save_dir_path_flable, save_dir_path_fuison, save_dir_path_default)

    fusion_config = '/media/sda1/cyn-workspace/mmdetection/work_dirs/final_experiment/UIML/UIML+fuison/resnet_fpn_cascadeRPN_cascadeROI_default.py'
    fusion_checkpoint = '/media/sda1/cyn-workspace/mmdetection/work_dirs/final_experiment/UIML/UIML+fuison/latest.pth'
    default_config = '/media/sda1/cyn-workspace/mmdetection/work_dirs/final_experiment/UIML/UIML/resnet_fpn_cascadeRPN_cascadeROI_default.py'
    default_checkpoint = '/media/sda1/cyn-workspace/mmdetection/work_dirs/final_experiment/UIML/UIML/latest.pth'
...
#        merge_proposal(img_root, img_root_path, result_d, result_f)
        ...
        default_lable = cv_plot_gt_label(img_images_default,img["file_name"],label_file_path=img_root_path +'test.json', out_file='demo/result.png')
        fusion_lable = cv_plot_gt_label(img_images_fusion, img["file_name"],label_file_path=img_root_path +'test.json', out_file='demo/result.png')
